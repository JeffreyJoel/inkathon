    ...
    <Card extra={`flex flex-col w-full h-full !p-4 3xl:p-![18px] bg-white ${extra}`}>
      <div className="h-full w-full">
        <div className="relative w-full">
          ...
          >
            <div className="dark:text-navy-900 flex h-full w-full items-center justify-center rounded-full text-xl hover:bg-gray-50">
        ...
        <div className="3xl:flex-row 3xl:justify-between mb-3 flex items-center justify-between px-1 md:flex-col md:items-start lg:flex-row lg:justify-between xl:flex-col xl:items-start">
          <div className="mb-2">
            <p className="text-navy-700 text-lg font-bold dark:text-white"> {title} </p>
          ...
          <div className="flex flex-row-reverse md:mt-2 lg:mt-0">
            ...
            {bidders.map((avt, key) => (
              <span
                key={key}
                className="dark:!border-navy-800 -mr-3 h-8 w-8 rounded-full border border-white"
              >
                <Image
                  width="2"
                  height="20"
        ...
        <div className="3xl:flex-row 3xl:items-center 3xl:justify-between flex items-center justify-between md:flex-col md:items-start lg:flex-row lg:justify-between xl:flex-col 2xl:items-start">
          ...
          <button className="linear bg-brand-900 hover:bg-brand-800 active:bg-brand-700 dark:bg-brand-400 dark:hover:bg-brand-300 rounded-[20px] px-4 py-2 text-base font-medium text-white transition duration-200 dark:active:opacity-90">
            Place Bid
          </button>
        </div>
      </div>
