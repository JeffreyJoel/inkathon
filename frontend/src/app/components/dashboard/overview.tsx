      ...
      {!contractCreated ? (
        ...
        <div>
          ...
          <div className="mt-8 flex justify-center">
            <div className="mr-8 block max-w-sm cursor-pointer rounded-lg border border-gray-600 p-6 shadow">
          ...
          <div className="mt-20">
            <h3 className="mb-5 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
              Token Contracts
            </h3>
            <TokenTable />
          </div>
